...
namespace BeardedManStudios.Network
{
	...
	public sealed class BMSByte
	{
		...
		/// <summary>
		/// Adds the given BMSByte objects bytes to the end of the byte array and resizes when needed
		/// </summary>
		/// <param name="input">The BMSByte to be appended to the end of the internal byte array</param>
		//public void Append(BMSByte input)
		//{
		//	if (input.Size <= index + input.Size)
		...
		/// <summary>
		/// This will get the Vector2 value from this data
		/// </summary>
		/// <param name="start">The byte start index to read from</param>
		...
		/// <summary>
		/// This will get the Vector3 value from this data
		/// </summary>
		/// <param name="start">The byte start index to read from</param>
		...
		/// <summary>
		/// This will get the Vector4 value from this data
		/// </summary>
		/// <param name="start">The byte start index to read from</param>
		...
		/// <summary>
		/// This will get the Color value from this data
		/// </summary>
		/// <param name="start">The byte start index to read from</param>
